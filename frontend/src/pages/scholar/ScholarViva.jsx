      ...
      <div className="page-body">
        {vivaScheduled ? (
          <>
            {/* Viva Banner */}
            <div style={{
              background: 'linear-gradient(135deg, #0A2A66, #0A2A66, #174EA6)',
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', gap: '10px', marginTop: '14px' }}>
                  <button className="btn" style={{ background: 'rgba(255,255,255,0.15)', color: '#fff', border: '1px solid rgba(255,255,255,0.3)' }}> Add to Calendar</button>
                  <button className="btn" style={{ background: '#fff', color: '#0A2A66', fontWeight: 700 }}> Hall Ticket</button>
                </div>
              </div>
              {/* Countdown */}
              <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.1)', borderRadius: 'var(--radius-lg)', padding: '20px 28px' }}>
                ...
                <div style={{ fontSize: '52px', fontWeight: 900, lineHeight: 1, color: '#FFF6D8' }}>117</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  {[
                    { role: 'Chairman (External)', name: vivaDetails.chairman, icon: '', badge: 'External' },
                    { role: 'External Examiner', name: vivaDetails.examiner1, icon: '', badge: 'External' },
                    { role: 'Internal Examiner', name: vivaDetails.examiner2, icon: '', badge: 'Internal' },
                    ...
                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 0', borderBottom: i < 3 ? '1px solid var(--border)' : 'none' }}>
                      <div style={{ width: 40, height: 40, borderRadius: '50%', background: '#E8EEF8', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', flexShrink: 0 }}>{p.icon}</div>
                      <div style={{ flex: 1 }}>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  {[
                    ...
                    { label: 'Venue', value: vivaDetails.venue, icon: '' },
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                  {GUIDELINES.map((g, i) => (
                    <div key={i} style={{ display: 'flex', gap: '10px', padding: '12px 14px', background: '#F8FAFC', borderRadius: 'var(--radius-md)', alignItems: 'flex-start' }}>
                      <span style={{ width: 22, height: 22, borderRadius: '50%', background: '#174EA6', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', fontWeight: 700, flexShrink: 0, marginTop: '2px' }}>{i + 1}</span>
